...
params.lags = 3; % number of lags per channel
params.K = 1; % number of output filters to take into account
...
params.simulation.Ntarget = randi(params.C); % number of target signals
params.simulation.Nnoise = randi(params.C); % number of noise signals
